        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8">
          ...
          <div className="lg:col-span-2">
            ...
            <p className="text-gray-400 mb-6 max-w-md">
              Transform your learning journey with Kalpla's comprehensive educational platform. 
              Join thousands of learners worldwide in mastering new skills and advancing their careers.
            </p>
